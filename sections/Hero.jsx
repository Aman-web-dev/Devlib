                ...
                <div class="space-y-8">
                    <div class="space-y-4">
                        <div class="space-y-2">
                            ...
                            <h1 class="text-4xl font-bold tracking-tight text-white sm:text-5xl md:text-6xl">
                                ...
                                <span
                                    class="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-pink-600">Dev Lib
                                </span>
                                <br/>
                                Has Got Your Back
                            </h1>
                    ...
                    <div class="flex space-x-4 items-center text-white">
                        <div class="flex items-center space-x-2">
                            ...
                            <span class="flex-shrink-0 text-xs font-medium leading-5">Start Contributing</span>
                        ...
                        <a href="" target="_blank">
                            <img src={github} className="w-32 h-8 md:w-48 md:h-12 lg:w-64 lg:h-16" width="250" height="54"/>
                        </a>
                    </div>
                </div>
            </div>
